          ...
          <div class="flex-1 flex justify-between px-4 sm:px-6">
            <div class="flex-1 flex">
              <form class="w-full flex md:ml-0" action="#" method="GET">
                <label for="search-field" class="sr-only">Search Suppliers</label>
            ...
            <div class="ml-2 flex items-center space-x-4 sm:ml-6 sm:space-x-6">
              ...
              <button type="button"
                class="flex p-1 rounded-full items-center justify-center text-blue focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
